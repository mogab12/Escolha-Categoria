...
class AvaliacaoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'nivel_engajamento_social': forms.RadioSelect(choices=CHOICES),
            'prazer_participacao': forms.RadioSelect(choices=CHOICES),
            'valor_emocional': forms.RadioSelect(choices=CHOICES),
            'habilidade_competencia': forms.RadioSelect(choices=CHOICES),
